...
*** 
Here I made two keygrams about the song 'Apocalypse' and 'Highest In The Room'. These are the only two songs that appear in both our playlists. Because those songs are both very different but they do appear in both our playslists, I thaught it might be interesting to work this out. In the timbre and chroma self-similarity matrixes on the other page, it becomes clear that there is a more structered pattern in Highest in The Room than in Apocalypse. I also see this in the keygrams. In Highest in The Room, there is more structure than in Apocalypse. In Highest in The Room, there is a clear difference between couplets and refrains and then around 150 seconds, it changes to something else. I don't know if the key is really correct because the chords in the song are Dm and Am, until 150 seconds. And this part is correct because there comes a Bb and in the keygram, this one is really dark there. In the keygram of Apocalypse, there is a vague pattern that continues trough the whole song. Also, this keygram is much darker than that of the other song. The keys are almost correct. Only the C#min is not logical.
