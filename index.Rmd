...
*** 
The only two songs that appear in both our playlists, Apocalypse by Cigarettes After Sex and Highest In The Room by Travis Scott, are very different in genre. Apocalypse is slowly and Highest In The Room is hiphop. So it could be interesting to look at the differences in the self-similarity matrixes. I don't really know how I can make it more workable, so that they are for example, standing next to each other.
